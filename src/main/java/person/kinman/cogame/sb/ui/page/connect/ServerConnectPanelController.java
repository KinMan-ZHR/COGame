package person.kinman.cogame.sb.ui.page.connect;
...
import person.kinman.cogame.sb.contract.Connectable;
import person.kinman.cogame.sb.ui.BaseController;
import person.kinman.cogame.sb.ui.page.connect.enums.ConnectionButtonStatus;
import person.kinman.cogame.sb.ui.page.connect.events.ServerConnectRequestEvent;
import person.kinman.cogame.sb.ui.page.connect.events.ServerConnectResponseEvent;
import person.kinman.cogame.sb.ui.page.connect.events.ServerDisconnectRequestEvent;
...
public class ServerConnectPanelController extends BaseController {
    private Connectable networkProxy;
