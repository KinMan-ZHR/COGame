...
public class StartPanel extends JPanel {
    ...
    public StartPanel(GameLauncher mainFrame) {
    ...
    private void initUI() {
        ...
        JLabel titleLabel = new JLabel("游戏战场");
        ...
        // 本地对战按钮
        JButton localBtn = createButton("本地对战", new Color(70, 130, 180));
        localBtn.addActionListener(e -> mainFrame.showPanel(GameLauncher.LOCAL_GAME_PANEL));

        // 联网对战按钮
        JButton onlineBtn = createButton("联网对战", new Color(100, 149, 237));
        onlineBtn.addActionListener(e -> mainFrame.showPanel(GameLauncher.ONLINE_GAME_PANEL));
